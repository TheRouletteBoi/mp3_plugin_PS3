...
NativeContext::NativeContext()
{
	m_nArgCount = 0;
	m_uiReadCount = 0;
	m_pArgs = (int*)malloc(32 * sizeof(unsigned int));
	m_pReturn = m_pArgs;
}
...
#define joaat(value) call<unsigned int>(0x0E75894)(value)
#define registerNative(nativeHash, nativeFuntion, r5, r6, r7, r8) call<void>(0x0E79460)(nativeHash, nativeFuntion, r5, r6, r7, r8)
...
unsigned int GetNativeAddress(char* name)
{
	if (strlen(name) > 0)
	{
		return GetNativeAddressFromHash(joaat(name));
	}
...
{ \
	cxt.nativePush(va_arg(_nativeVarArgsList, Any)); \
}
...
namespace GRAPHICS
{
	...
	static void DRAW_LINE() { invoke<Void>(0xB3426BCC); } // unused
